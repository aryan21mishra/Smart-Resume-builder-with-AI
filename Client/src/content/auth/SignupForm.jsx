...
const SignupForm = () => {
  ...
  const { mutate: registeration, isPending: isLoading } = useRegisterMutation();
  ...
  return (
    <div className="w-full">
      <div className="text-center">
        <h2 className="text-4xl text-[#e8b86d]  font-montserratBold">
          Create an Account
        </h2>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="flex items-center justify-center">
          <Button
            ...
            size="lg"
            disabled={isLoading}
            className={`${isLoading ? "pointer-events-none opacity-70 " : ""} border-gray-300 uppercase font-montserratRegular w-full`}>
            {isLoading ? (
      ...
      <div className="mt-4">
        <Button
          ...
          variant="outline"
          size="lg"
          className="border-gray-300 uppercase font-montserratRegular! font-medium w-full">
          {isGoogleLoading ? (
